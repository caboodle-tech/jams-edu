export default () => {
    class JamsEduSortable {
        ...
        #addSortIcons() {
            let header = this.#elem.querySelector('thead');
            if (header) {
            ...
            if (!header) {
                header = this.#elem.querySelector('tbody');
                if (header) {
            ...
            if (!header) {
                header = this.#rowWithoutColspan([this.#elem.querySelector('tr')]);
            }
        ...
        #sort(evt) {
            ...
            this.#header.querySelector('.sort-icon.selected')?.classList.remove('selected');
            ...
            this.#header.querySelectorAll('[data-je-sort]').forEach((oldSortedColumn) => {
                ...
                oldSortedColumn.querySelector('.sort-icon').innerHTML = JamsEduIcon.get('sort');
            });
        ...
        #standardize() {
            ...
            let parent = this.#elem.querySelector('tbody');
            if (!parent) {
                parent = this.#elem; // No tbody, standardize the whole table.
            }
