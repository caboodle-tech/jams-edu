class JamsEduIcons {
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15 2h2v5h7v2h-9v-7zm9 13v2h-7v5h-2v-7h9zm-15 7h-2v-5h-7v-2h9v7zm-9-13v-2h7v-5h2v7h-9z"/></svg>',
        ...
        danger:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0l-12 12 12 12 12-12-12-12zm0 13.323l-2.464 2.464-1.323-1.324 2.463-2.463-2.463-2.463 1.324-1.324 2.463 2.463 2.462-2.463 1.324 1.323-2.462 2.464 2.463 2.463-1.324 1.324-2.463-2.464z"/></svg>',
        document:
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M23.111 20.058l-4.977-4.977c.965-1.52 1.523-3.322 1.523-5.251 0-5.42-4.409-9.83-9.829-9.83-5.42 0-9.828 4.41-9.828 9.83s4.408 9.83 9.829 9.83c1.834 0 3.552-.505 5.022-1.383l5.021 5.021c2.144 2.141 5.384-1.096 3.239-3.24zm-20.064-10.228c0-3.739 3.043-6.782 6.782-6.782s6.782 3.042 6.782 6.782-3.043 6.782-6.782 6.782-6.782-3.043-6.782-6.782zm2.01-1.764c1.984-4.599 8.664-4.066 9.922.749-2.534-2.974-6.993-3.294-9.922-.749z"/></svg>',
        sort: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path style="transform: scale(0.75); transform-origin: center;" d="M12 0l8 10h-16l8-10zm8 14h-16l8 10 8-10z"/></svg>',
        sortAsc:
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 22v-20h16v11.543c0 4.107-6 2.457-6 2.457s1.518 6-2.638 6h-7.362zm18-7.614v-14.386h-20v24h10.189c3.163 0 9.811-7.223 9.811-9.614zm-11.788-1.02c.463-1.469 1.341-3.229 1.496-3.675.225-.646-.173-.934-1.429.171l-.279-.525c1.432-1.559 4.382-1.91 3.379.504-.627 1.508-1.076 2.525-1.332 3.31-.374 1.144.57.68 1.494-.173.126.206.167.271.293.508-2.053 1.953-4.33 2.125-3.622-.12zm3.895-6.71c-.437.372-1.084.364-1.446-.018-.362-.382-.302-.992.135-1.364.437-.372 1.084-.363 1.446.018.361.382.302.992-.135 1.364z"/></svg>',
        ...
        video:
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 1v22h24v-22h-24zm4 20h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm14 12h-12v-10h12v10zm4 4h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2v-2h2v2zm-12 10v-6l5 3-5 3z"/></svg>',
